...
{
    public class HanoiWorkflowState : INotifyPropertyChanged
    {
        ...
        {
            get { return _stack1; }
            set { _stack1 = value; OnChanged(nameof(Stack1)); }
        }
        ...
        {
            get { return _stack2; }
            set { _stack2 = value; OnChanged(nameof(Stack2)); }
        }
        ...
        public bool IsFinished => ((NumberDisks % 2 == 0) ? (Stack2.Count == NumberDisks) : (Stack3.Count == NumberDisks));
        ...
        {
            get { return _stack3; }
            set { _stack3 = value; OnChanged(nameof(Stack3)); }
        }
