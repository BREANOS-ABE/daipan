...
// <copyright file="ICWFActor.cs" company="Breanos GmbH">
// Copyright Notice:
...
//namespace CWFActor.Interfaces
{
    ...
    /// </summary>
    public interface ICWFActor : IActor
    {       
        Task<string> HelloWorldAsync();

        Task<int> StartWorkflowEngine();

        Task<int> StartWorkflowEngine2();
    }
}
