...
namespace CWF.Tasks.GetGantryJob
{
    public class GetGantryJob : CWF.Core.StatefulActivity<FertigungszelleWorkflowState>
    {
        private static NLog.Logger logger = LogManager.GetCurrentClassLogger();
        public GetGantryJob(ActivityMemento activityMememnto) : base(activityMememnto)
        {
        }
