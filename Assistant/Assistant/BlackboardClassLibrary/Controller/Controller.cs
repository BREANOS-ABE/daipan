...
namespace BlackboardClassLibrary.Controller
{
    ...
    public class Controller
    {
        ...
        public Controller(Blackboard.Blackboard blackboard)
        {
            ...
            BreanosServiceBusMessages breanosServiceBusMessages1 = new BreanosServiceBusMessages("LineTopic_1", "Sub2", string.Empty) { IsEnabled = false };//KS;
