...
namespace BreanosConnectors
{
    public static class SerializationHelper
    {
        ...
        /// Serializes a given object into Xml
        /// If the object cannot be serialized, this will throw an exception
        /// This version is generally more useful if you e.g. got the type from <see cref="object.GetType()"/>
        /// </summary>
        ...
        public static bool TryDeserialize<T>(string s, out T o)
        {
            ...
            if (s == null) { o = default(T); return false; }
            XmlSerializer serializer = new XmlSerializer(typeof(T));
        ...
        /// <summary>
        /// Attempts to deserialize a given Xml-compliant string into an object of a class
        /// If the object cannot be deserialized, an exception may be thrown
        /// <para>Reasons why the object cannot be deserialized may include</para>
        /// <para>You have a Dictionary property in your object. Use a backing array of (string,SomeClass), i.e. fields in C# 7.0 which you can use as a dictionary via a Property Getter with XmlIgnoreAttribute</para>
        /// <para>You are using interfaces instead of classes for your properties, e.g. IEnumerable, IMyInterface instead of List, MyConcreteImplementation. We would discourage the usage of complex inheritance patterns for DTOs</para>
        /// <para>You have a property of a type which internally violates one of the rules above</para>
        /// </summary>
        /// <param name="s">The string to be deserialized</param>
        /// <param name="expectedType">The type you expect the object to be. Possibly inferred from some call like <see cref="Type.GetType(string)"/></param>
        /// <param name="o">the out object to be instantiated. You may need to cast this into the proper type to access its members.</param>
        /// <returns></returns>
        public static bool TryDeserialize(string s, Type expectedType, out object o)
        {
            if (s==null) { o = (expectedType.IsValueType) ? (Activator.CreateInstance(expectedType)) : (null); return false; }
        ...
        {
            if (uncompressedInput == null) return null;
            byte[] buffer;
        ...
        /// <summary>
        /// Encapsulates Serialization and Compression, especially for reflection-typed objects
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="obj"></param>
        /// <returns></returns>
        public static string Pack(Type type, object o)
        {
            return Compress(Serialize(type, o));
        }
        /// <summary>
        ...
        /// <summary>
        /// Encapsulates Decompression and Deserialization, especially for reflection-typed objects.
        /// see <see cref="Type.GetType(string)"/>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="input"></param>
        /// <param name="obj"></param>
        /// <returns></returns>
        public static bool TryUnpack(string input, Type expectedType, out object o)
        {
            return TryDeserialize(Decompress(input), expectedType, out o);
        }
    }
}
